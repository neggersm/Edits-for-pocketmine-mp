...
class Block extends Position implements Metadatable{
	...
	public static function init(){
		if(self::$list === null){
			...
			self::$list[self::SPRUCE_FENCE] = SpruceFence::class;
			self::$list[self::BIRCH_FENCE] = BirchFence::class;
			self::$list[self::DARK_OAK_FENCE] = DarkOakFence::class;
			self::$list[self::JUNGLE_FENCE] = JungleFence::class;
			self::$list[self::ACACIA_FENCE] = AcaciaFence::class;
